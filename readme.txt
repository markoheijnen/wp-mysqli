...
MySQL is deprecated and this plugin creates a layer to use MySQLi instead. So you don't get notices when using PHP 5.5
...
2. Copy `db.php` to your WordPress content directory (`wp-content/` by default).
3. Done!